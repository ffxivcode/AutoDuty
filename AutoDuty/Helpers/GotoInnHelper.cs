...
namespace AutoDuty.Helpers
{
    internal unsafe static class GotoInnHelper
    {
        ...
        private static IGameObject? _innKeepGameObject = null;
        ...
        internal static unsafe void GotoInnUpdate(IFramework framework)
        {
            ...
            if (Svc.ClientState.TerritoryType != ObjectHelper.GrandCompanyTerritoryType(_whichGrandCompany) || (_innKeepGameObject = ObjectHelper.GetObjectByDataId(Convert.ToUInt32(_innKeepDataId))) == null || Vector3.Distance(Svc.ClientState.LocalPlayer.Position, _innKeepGameObject.Position) > 7f)
            {
