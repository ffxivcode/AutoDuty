...
namespace AutoDuty.Helpers
{
    internal unsafe static class GotoBarracksHelper
    {
        ...
        internal static uint ExitBarracksDoorDataId(uint _grandCompany) => _grandCompany == 1 ? 2007528u : (_grandCompany == 2 ? 0u : 0u);
        ...
        private static uint _barracksDoorDataId => UIState.Instance()->PlayerState.GrandCompany == 1 ? 2007527u : (UIState.Instance()->PlayerState.GrandCompany == 2 ? 0u : 0u);
